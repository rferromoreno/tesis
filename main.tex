...
\input{Chapters/IntroTesis/index}
%\input{Chapters/IntroJS/index}
\include{Chapters/Chapter1} % Introducción
\part{Sistema de tipos}
\include{Chapters/Chapter2} % Sistema de tipos
\input{Chapters/Coercion/index}
\input{Chapters/Scope/index}
%\include{Chapters/Chapter3} % Programación funcional
%\include{Chapters/Chapter4} % Programación orientada a objetos
\part{Paradigmas de programación}
\input{Chapters/PF/index}
\input{Chapters/POO/index}
%\include{Chapters/Chapter5} % Expresiones
%\include{Chapters/Chapter6} % Scope
%\include{Chapters/Chapter7} % this en JavaScript
