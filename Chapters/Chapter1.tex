...
Para entendimiento del lector, se presentan algunos conceptos que se mencionarán en algunos capítulos. No son exclusivamente del lenguaje, pero comprender y saber que el lenguaje dispone de éstas cualidades, ayudará a explicar cómo funcionan otras caracteristicas dentro del lenguaje.

\subsubsection{Hoisting}

Del inglés "`levantamiento"', el término de hoisting es muy acuñado y asociado a JavaScript. 
...
\begin{itemize}
	\item Se lo puede pensar como un scope de bloque, un scope local donde se pueden definir variables sin ser afectadas desde afuera.
	\item Sirven para crear módulos o namespaces, sin necesidad de ocupar nombres en el espacio que estemos usando.
\end{itemize}
