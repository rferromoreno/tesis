...
Dejando de lado el resto de los tipos primitivos, el tipo por excelencia dentro del lenguaje es \code{object}. En JavaScript \textit{casi todo} es un objeto: arreglos, funciones, clases, módulos. Existen diversas formas de crear un objeto, todas ellas son válidas.
