...
Para cerrar ésta parte del capítulo, es necesaria la aclaración que los cuatro tipo de ligaduras presentadas tienen un orden de precedencia. Es importante para el programador conocer éste mismo para no caer en la problemática de que el \code{this} no esté ligado a algo inesperado.
