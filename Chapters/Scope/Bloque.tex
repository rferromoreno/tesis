...
Este tipo de scope se llama "`por bloque"'. No obstante, en JavaScript no existe el scope por bloque, o al menos no con la palabra \code{var} (más adelante en la sección \ref{subsec:letyconst}, veremos cómo se introdujo en ES6).
