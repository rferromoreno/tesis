...
Si bien puede resultar un poco confuso al principio, para quienes estén acostumbrados al patrón Factory, este ejemplo quizás resulta algo natural. A simple vista, la única \textit{ventaja} es que omitimos el uso del \code{new} a la hora de realizar la instanciación de nuevos objetos. 
...
\subsection{ES6 y \code{class} al... ?`rescate?}
