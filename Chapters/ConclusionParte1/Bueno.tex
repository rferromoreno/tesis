...
El uso de funciones para creación de un scope local es sin dudas un acierto, pero mayor acierto fue la introducción de scope por bloques con el uso de \code{const} y \code{let}. Dicha característica ayuda a mantener limpio el espacio de nombres, y declarar variables de forma léxica.