...
\keyword{AWK} -- Sintácticamente, la forma de declarar funciones fue heredada de éste lenguaje.
...
\keyword{Perl y Python} -- Ambos lenguajes han influido en el manejo de strings, arreglos y expresiones regulares en JavaScript.
