...
Las propiedades se identifican usando claves. El valor de una clave puede ser o bien un \code{String}, o bien un \code{Symbol}. Todos los valores \code{String} y \code{Symbol} son válidos como nombre clave para una propiedad, inclusive la cadena vacía. 
